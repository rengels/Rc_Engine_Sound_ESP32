...
volatile int dieselKnockVolumePercentage = 140; // Adjust the Diesel knock volume (usually = 40 - 120%) 140
...
volatile int turboVolumePercentage = 16; // Adjust the turbo volume (usually = 14%)
