...
//#include "sounds/FreightlinerCummins350CaboverJakebrake2.h" // Freightliner Cummins 350 R6 Diesel
#endif
...
volatile int dieselKnockVolumePercentage = 120; // Adjust the Diesel knock volume (usually = 40 - 120%)
