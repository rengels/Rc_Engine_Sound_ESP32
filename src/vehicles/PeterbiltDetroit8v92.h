...
volatile int startVolumePercentage = 136; // Adjust the start volume (usually = 80%)
//#include "sounds/Cat3408Start.h" // CAT 3408 V8 Diesel start (Kenworth W900A)
#include "sounds/8v92PeterbiltStart.h" // Peterbilt with Detroit 8V92 2 stroke V8 Diesel
...
#include "sounds/8v92PeterbiltIdle.h" // Peterbilt with Detroit 8V92 2 stroke V8 Diesel
...
#ifdef REV_SOUND
#include "sounds/8v92PeterbiltRev.h" // Peterbilt with Detroit 8V92 2 stroke V8 Diesel
#endif
...
#include "sounds/8v92PeterbiltJakeBrake.h" // Peterbilt with Detroit 8V92 2 stroke V8 Diesel
...
volatile int dieselKnockVolumePercentage = 90; // Adjust the Diesel knock volume (usually = 40 - 120%) 140
...
volatile int dieselKnockAdaptiveVolumePercentage = 25; // Adjust the Diesel knock volume for the non-first knocks per engine cycle (usually = 50%) 18
...
#endif // ********************************************************************************
#include "sounds/8v92PeterbiltKnock.h" // Peterbilt with Detroit 8V92 2 stroke V8 Diesel

// Adjust the additional turbo sound (set "turboVolumePercentage" to "0", if you don't want it) --------
volatile int turboVolumePercentage = 10; // Adjust the turbo volume (usually = 14%)
...
//#define GEARBOX_WHINING // Disables sound, if gearbox in neutral. Fan noise is used to simulate gearbox whining (set fanStartPoint above
...
//#include "sounds/CaboverCAThorn.h" // Cabover wit CAT engine horn (King Hauler)
...
volatile int sirenVolumePercentage = 104; // Adjust the siren volume (usually = 80%)
