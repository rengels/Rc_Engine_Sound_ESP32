...
volatile int revVolumePercentage = 104; // Adjust the idle volume (usually = 80%, more also working, depending on sound)
...
volatile int dieselKnockVolumePercentage = 26; // Adjust the Diesel knock volume (usually = 40 - 120%)
