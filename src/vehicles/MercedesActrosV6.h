...
volatile int startVolumePercentage = 128; // Adjust the start volume (usually = 80%)
...
volatile int revVolumePercentage = 128; // Adjust the idle volume (usually = 80%, more also working, depending on sound)
...
volatile int dieselKnockVolumePercentage = 160; // Adjust the Diesel knock volume (usually = 40 - 120%) 140
...
volatile int turboVolumePercentage = 30; // Adjust the turbo volume (usually = 14%)
...
volatile int wastegateVolumePercentage = 50; // Adjust the wastegate volume (usually = 14%, up to 50%)
...
volatile int indicatorVolumePercentage = 0; // Adjust the indicator sound volume (usually = 10%)
